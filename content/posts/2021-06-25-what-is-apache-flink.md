...
![](/images/wp/2021/06/Apache_Flink_logo.png)
...
![](/images/wp/2021/06/Rethinking-Flinks.jpg)  
...
You can check my blog for windows explanation [here](/what-is-stream-processing/) on item 8.
...
![](/images/wp/2021/06/flink03.png)  
Picture 4: several time-based windows

**Note**: here is another place that could be explained using a Led Strip. Check out my blog post about Led Strip [here](/learn-kafka-and-event-streams-with-fun/).

![](/images/wp/2021/06/win_led01.jpg)  
