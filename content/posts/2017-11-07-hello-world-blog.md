...
tags:
- motivational
description: 'Hey you! I’ve been thinking an about creating a blog for some time,
  and today I finally Get up the courage to start something. If a busy guy like Brendan
  Eich´s keeps a blog, why I can not have mine too?'
...
If a busy guy like [Brendan Eich´s](https://brendaneich.com/) keeps a blog, why I can not have mine too?
...
The blog uses a [WordPress theme](https://wordpress.org/themes/twentytwelve/) and is hosted by [Godaddy](https://ie.godaddy.com/)
