...
![](/images/wp/2018/02/sensehat-300x218.jpg)
...
|  |  |
| --- | --- |
| 1 2 | sudo apt-get install sense-hat  sudo pip-3.2 install pillow |
...
|  |  |
| --- | --- |
| 1 2 3 4 5 6 7 8 | from sense\_hat import SenseHat  import time    hat = SenseHat()    while true:      bearing = sense.get\_compass()      print ('bearing: {:.0f} to north' .format(bearing)) |
