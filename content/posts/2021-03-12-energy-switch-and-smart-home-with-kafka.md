...
![](/old-igfasouza-blog/images/wp/2021/03/Lamp-switch3.jpg)
...
![](/old-igfasouza-blog/images/wp/2021/03/smart_home01.jpg)
...
I already did a blog about [TP-link smart plush](/old-igfasouza-blog/smart-plug-tp-link/), but today I want to use a Java API that I found [here](https://github.com/CalicoCatalyst/hs-100) and [here](https://github.com/Phi-S/tplink_smartplug_HS110). I kind of did a mix of both.
...
For configure kafka just need add the settings on “application.yml”. Here I did with my [raspberry pi kafka cluster](/old-igfasouza-blog/raspberry-pi-kafka-cluster/).

![](/old-igfasouza-blog/images/wp/2021/03/01.jpg)
...
And you can combine this with my [influxdb-and-grafana](/old-igfasouza-blog/raspberry-pi-with-influxdb-and-grafana/) blog and add some nice visualization.

Smart Plug HS110

Smart Light lb110

![](/old-igfasouza-blog/images/wp/2021/03/Screenshot-2021-03-10-at-19.05.32-1024x333.png)
